...
type AssayMethodRepository interface {
	...
	FindByCode(context.Context, string) (model.AssayMethod, error)
...
func (r *assayMethodRepository) FindByCode(ctx context.Context, code string) (model.AssayMethod, error) {
	return r.store.FindOne(ctx, "code", code)
}
